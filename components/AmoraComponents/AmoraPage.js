  ...
  return (
    <>
      <Container>
        ...
        <p className="justify-content-center mx-4 display-6">Amora Villas</p>
      ...
      <Container>
        <Row className="g-4">
          <Col lg={6}>
            <img className="w-100" src="/images/Amora-Group-1.png" />
          </Col>
          <Col lg={6}>
            <img className="w-100" src="/images/Amora-Group-2.png" />
          </Col>
          <div className="text-center">
            <img src="/images/slideArrow.svg" />
          </div>
        </Row>
      </Container>
      <Container>
      ...
      <Container>
        <Row className="mt-5">
          ...
          <Col>
            <p className="fs-5 text-start p-lg-5 mt-5">
      ...
      <p className="fs-5 bg-white p-4 position-absolute bottom-0 end-0 mb-0  col-lg-6 amora-fluid border">
