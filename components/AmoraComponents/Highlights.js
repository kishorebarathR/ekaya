      ...
      <Container className="p-5">
        <Row>
          <Col lg={3} className="mb-3">
            <div className="text-center talkbubble w-100 p-5 fs-6 h-100"> {/* Changed fs-5 to fs-6 */}
              Hotels & Resorts
            </div>
          </Col>
          <Col lg={5}>
        ...
        <Row>
          <Col lg={3} className="mb-3">
            <div className="text-center justify-content-center talkbubble w-100 p-5 h-100 fs-6"> {/* Changed fs-5 to fs-6 */}
        ...
        <Row>
          <Col lg={3} className="mb-3">
            <div className="text-center talkbubble w-100 h-100 p-4 fs-6"> {/* Changed fs-5 to fs-6 */}
              Schools
            </div>
          </Col>
          <Col lg={5}>
