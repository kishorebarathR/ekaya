    ...
    <>
      ...
      <Container className='mt-5 d-flex flex-column gap-5'>
        ...
        <Row className='mt-5'>
          ...
          <Col className='p-5 d-flex flex-column justify-content-center postion-relative' sm={12} lg={7}>
            <p className='fs-5 mb-0'>Rich in cultural heritage, Dona Paula boasts landmarks such as the Cabo Raj Bhavan, once a Portuguese fort and now the official residence of the Governor of Goa. Its vibrant markets and proximity to renowned beaches like Miramar and Vainguinim further elevate its charm, offering a perfect blend of relaxation and exploration.</p>
          </Col>
        </Row>

        <Row className=' d-flex flex-lg-row flex-column-reverse'>
          <Col className='p-5 d-flex flex-column justify-content-center' sm={12} lg={7}>
            <p className='fs-5 mb-0'>With its timeless beauty, affluent ambiance, and enchanting coastal vistas, Dona Paula continues to enchant visitors and residents alike, promising an unforgettable experience amidst the wealth and luxury of Goa’s coastal paradise.</p>
          </Col>
